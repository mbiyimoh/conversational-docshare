...
export function ShareLinkManager({ projectId, projectName = 'Project' }: ShareLinkManagerProps) {
  ...
  const handleCreate = async () => {
    ...
    try {
      const requestPayload = {
        ...
        // Include opening message if set (from preview editor)
        openingMessage: openingMessage || undefined,
        openingMessageVersions: openingMessageVersions.length > 0 ? openingMessageVersions : undefined,
      }

      const data = await api.createShareLink(projectId, requestPayload)
      const newLink = data.shareLink as ShareLink
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Create New Link - 4 Section Layout */}
      <Card className="p-6">
        ...
        <div className="space-y-4">
          ...
          <ShareLinkSection number="01" title="AUDIENCE">
            <div className="space-y-4">
              ...
              {selectedProfileId && (
                <p className="text-xs text-accent">Settings imported from profile. You can customize below.</p>
              )}
          ...
          <ShareLinkSection number="03" title="OPENING MESSAGE" defaultOpen={false}>
          ...
          <ShareLinkSection number="04" title="CUSTOMIZE LINK" defaultOpen={false}>
            <div className="space-y-4">
              {/* Link Name */}
              <div>
              ...
              <div>
                ...
                {showCustomSlug && (
                  <div className="mt-2 space-y-2">
                    ...
                    {!customSlug && <p className="text-sm text-muted">Leave empty for a random URL</p>}
                  </div>
                )}
              </div>
            </div>
